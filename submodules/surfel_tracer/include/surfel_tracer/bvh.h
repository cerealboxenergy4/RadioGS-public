...
public:
    ...
    virtual void gaussian_trace_forward(
        ...
        const float alpha_min, const float transmittance_min, const int deg, const int max_coeffs, const bool back_culling, const float super_gaussian_order, const bool first_hit_only, unsigned long long* counters, const int n_prefix, cudaStream_t stream) = 0;
    virtual void gaussian_trace_backward(
        ...
        const float alpha_min, const float transmittance_min, const int deg, const int max_coeffs, const bool back_culling, const float super_gaussian_order, cudaStream_t stream) = 0;
